...
export default function AbilityScores({ character, updateAbility, collapsedSections, onToggleSection }: Props) {
  const collapsed = !!collapsedSections["abilities"];
  return (
    <section className="sheet-section abilities-section">
      <SectionHeader title="Ability Scores" collapsed={collapsed} onToggle={() => onToggleSection("abilities")} />
      {!collapsed && (
