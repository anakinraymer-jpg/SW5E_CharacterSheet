// PHB, Echoes of the Force (EC), and Wretched Hives (WH) feats, sourced from sw5e.com.
// One duplicate rules-note entry ("Fighting Styles and Masteries", listed under both EC and WH
// with near-identical text) is included only once.
...
export const FEATS_CATALOG: FeatEntry[] = [
  ...
  },
  {
    ...
    abilityOptions: [],
    text: "You know one at-will force power. Additionally, you know one 4th-level force power, which you can cast once per long rest. Your forcecasting ability is Wisdom or Charisma (depending on power alignment).",
  },
  {
    name: "Greater Tech Dabbler",
    prerequisite: "The ability to cast 3rd-level tech powers",
    abilityOptions: [],
    text: "You know one at-will tech power. Additionally, you know one 4th-level tech power, which you can cast once per long rest. Your techcasting ability is Intelligence. You require use of a wristpad for these powers.",
  },
  {
    name: "Heat Shielded",
    prerequisite: null,
  ...
  },
  {
    ...
    abilityOptions: [],
    text: "You know one at-will force power. Additionally, you know one 3rd-level force power, which you can cast once per long rest. Your forcecasting ability is Wisdom or Charisma (depending on power alignment).",
  },
  {
    name: "Improved Tech Dabbler",
    prerequisite: "The ability to cast 2nd-level tech powers",
    abilityOptions: [],
    text: "You know one at-will tech power. Additionally, you know one 3rd-level tech power, which you can cast once per long rest. Your techcasting ability is Intelligence. You require use of a wristpad for these powers.",
  },
  {
    name: "Master Force-Sensitive",
    prerequisite: "The ability to cast 4th-level force powers",
    abilityOptions: [],
    text: "You know one at-will force power. Additionally, you know one 5th-level force power, which you can cast once per long rest. Your forcecasting ability is Wisdom or Charisma (depending on power alignment).",
  },
  {
    name: "Master Tech Dabbler",
    prerequisite: "The ability to cast 4th-level tech powers",
    abilityOptions: [],
    text: "You know one at-will tech power. Additionally, you know one 5th-level tech power, which you can cast once per long rest. Your techcasting ability is Intelligence. You require use of a wristpad for these powers.",
  },
  {
    name: "Metabolic Tolerance",
    prerequisite: null,
